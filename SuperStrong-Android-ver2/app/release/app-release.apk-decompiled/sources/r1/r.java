...
public final class r {
    ...
    public static final boolean f5931g;

    /* renamed from: h  reason: collision with root package name */
    public static final boolean f5932h;

    /* renamed from: i  reason: collision with root package name */
    public static final File f5933i;

    /* renamed from: j  reason: collision with root package name */
    public static volatile r f5934j;

    /* renamed from: k  reason: collision with root package name */
    public static volatile int f5935k;
    ...
    public boolean f5940e = true;

    /* renamed from: f  reason: collision with root package name */
    public final AtomicBoolean f5941f = new AtomicBoolean(false);

    static {
        int i6 = Build.VERSION.SDK_INT;
        f5931g = i6 < 29;
        f5932h = i6 >= 26;
        f5933i = new File("/proc/self/fd");
        f5935k = -1;
    }
    ...
    */
    public r() {
        ...
        Lb9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: r1.r.<init>():void");
    }

    public final boolean a(int i6, int i7, boolean z5, boolean z6) {
        boolean z7;
        boolean z8;
        int i8;
        boolean z9;
        if (!z5) {
            ...
            if (z7) {
                ...
                if (i6 < i9) {
                    ...
                    synchronized (this) {
                        int i10 = this.f5939d + 1;
                        this.f5939d = i10;
                        if (i10 >= 50) {
                            this.f5939d = 0;
                            int length = f5933i.list().length;
                            if (f5935k != -1) {
                                i8 = f5935k;
                            } else {
                                i8 = this.f5937b;
